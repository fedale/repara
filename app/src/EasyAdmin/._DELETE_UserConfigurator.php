...
final class UserConfigurator implements FieldConfiguratorInterface
{
    ...
    {
        if (null !== $entryTypeFqcn = $field->getCustomOptions()->get(UserField::OPTION_ENTRY_TYPE)) {
        ...
        $field->setFormTypeOptionIfNotSet('allow_add', $field->getCustomOptions()->get(UserField::OPTION_ALLOW_ADD));
        $field->setFormTypeOptionIfNotSet('allow_delete', $field->getCustomOptions()->get(UserField::OPTION_ALLOW_DELETE));
        ...
        $field->setFormTypeOptionIfNotSet('entry_options.label', $field->getCustomOptions()->get(UserField::OPTION_SHOW_ENTRY_LABEL));

     
        $field->setFormattedValue($this->formatCollection($field, $context));

        if (true === $field->getCustomOption(UserField::OPTION_ENTRY_USES_CRUD_FORM)) {
            ...
            if (null !== $field->getCustomOptions()->get(UserField::OPTION_ENTRY_TYPE)) {
            ...
            $targetCrudControllerFqcn = $field->getCustomOption(UserField::OPTION_ENTRY_CRUD_CONTROLLER_FQCN)
            ...
            $crudEditPageName = $field->getCustomOption(UserField::OPTION_ENTRY_CRUD_EDIT_PAGE_NAME) ?? Crud::PAGE_EDIT;
            ...
            $crudNewPageName = $field->getCustomOption(UserField::OPTION_ENTRY_CRUD_NEW_PAGE_NAME) ?? Crud::PAGE_NEW;
