 ...
 */
final class TreeCheckboxConfigurator implements FieldConfiguratorInterface
{
    ...
    {
        return TreeCheckboxField::class === $field->getFieldFqcn();
    }
    ...
    public function configure(FieldDto $field, EntityDto $entityDto, AdminContext $context): void
    {
        ...
        // if (true === $field->getCustomOption(TreeCheckboxField::OPTION_AUTOCOMPLETE)) {
        //     $targetCrudControllerFqcn = $field->getCustomOption(TreeCheckboxField::OPTION_CRUD_CONTROLLER);
        ...
        //         ->setController($field->getCustomOption(TreeCheckboxField::OPTION_CRUD_CONTROLLER))
        //         ->setAction('autocomplete')
        //         ->set(TreeCheckboxField::PARAM_AUTOCOMPLETE_CONTEXT, [
        ...
        //         if ($queryBuilderCallable = $field->getCustomOption(TreeCheckboxField::OPTION_QUERY_BUILDER_CALLABLE)) {
