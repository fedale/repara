 ...
 */
final class TreeCheckboxField implements FieldInterface
{
    use FieldTrait;
    ...
    public static function new(string $propertyName, $label = null): self
    {
        return (new self())
            ...
            ->setQueryBuilder(
                fn (QueryBuilder $queryBuilder) => $queryBuilder->getEntityManager()->getRepository(UserRole::class)->findWithProfileAndGrouprs()
            )
        ;
    }
