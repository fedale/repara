...
final class Version20220901175907 extends AbstractMigration
{
    ...
    {
        $this->addSql('INSERT INTO setting VALUES (1, "fedale", "app", "myText", "Danilo Di Moia", "string", 1);');
        ...
        $this->addSql('INSERT INTO setting VALUES (5, "fedale", "app", "default_path", "/new/path/to/me", "string", 1);');
        $this->addSql('INSERT INTO setting VALUES (6, "fedale", "app", "anonymousAccess", "1", "bool", 1);');
