...
final class Version20220630192438 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE notification (id INT UNSIGNED AUTO_INCREMENT NOT NULL, notification_entity_id INT UNSIGNED DEFAULT NULL, entity_id INT UNSIGNED DEFAULT NULL COMMENT \'NULL with deleted entities\', message MEDIUMTEXT NOT NULL, status TINYINT(1) DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL DEFAULT current_timestamp(), updated_at DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(), deleted_at DATETIME DEFAULT NULL, INDEX created_at (created_at), INDEX updated_at (updated_at), INDEX entity_id (entity_id), INDEX active (status), INDEX entity_type_id (notification_entity_id), PRIMARY KEY(id)) ENGINE = InnoDB COMMENT = \'\' ');
